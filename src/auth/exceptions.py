...
class AuthException(HTTPException):
    ...
    def __init__(self, detail: str, error_code: AuthErrorCode):
        super().__init__(
            ...
            detail={"detail": detail, "error_code": error_code.value},
...
class InvalidCredentialsException(AuthException):
    ...
    def __init__(self):
        super().__init__(
            "Invalid username or password", AuthErrorCode.INVALID_CREDENTIALS
        )
...
class TokenExpiredException(AuthException):
    ...
    def __init__(self):
        super().__init__("Token has expired", AuthErrorCode.TOKEN_EXPIRED)
...
class TokenInvalidException(AuthException):
    ...
    def __init__(self):
        super().__init__("Invalid token", AuthErrorCode.TOKEN_INVALID)
...
class UserInactiveException(AuthException):
    ...
    def __init__(self):
        super().__init__("User account is inactive", AuthErrorCode.USER_INACTIVE)
