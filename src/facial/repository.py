...
class IProcessingJobRepository(ABC):
    ...
    @abstractmethod
    async def create_job(self, job_id: str, user_id: int, input_data: str) -> ProcessingJob:
    ...
    @abstractmethod
    async def update_job_status(self, job_id: str, status: str, output_data: str = None, error_message: str = None) -> bool:
        """Update job status."""
        pass
