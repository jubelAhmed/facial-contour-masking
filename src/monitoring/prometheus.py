...
PROCESSING_TIME = Histogram(
    "image_processing_time_seconds", "Image processing time in seconds", ["operation"]
)

JOB_COUNT = Counter("job_count_total", "Total count of jobs", ["status"])
...
def track_processing_time(operation_name):
    ...
    def decorator(func):
        async def wrapper(*args, **kwargs):
            ...
            PROCESSING_TIME.labels(operation=operation_name).observe(
